...
### 모니터링
![image alt](image/Operators Guide/Mornitoring_Mornitoring1.PNG)
![image alt](image/Operators Guide/Mornitoring_Mornitoring2.PNG)
...
### 설치 URL
##### 1) 조회
![image alt](image/Operators Guide/App_installUrl1.PNG)
...
##### 2) 수정
![image alt](image/Operators Guide/App_installUrl2.PNG)
...
### 점검
##### 1) 점검 리스트 조회
![image alt](image/Operators Guide/Maintenance1.PNG)
...
##### 2) 점검 등록
![image alt](image/Operators Guide/Maintenance2.PNG)
- 점검 등록을 수행하는 화면입니다.
- **(1) 대상**
  점검 대상에 대한 선택을 하는 항목입니다.
  `전체 게임/일부 클라이언트`가 선택이 가능하며, 클라이언트의 경우 앱-클라이언트 메뉴에서 등록한 클라이언트 버전리스트가 출력됩니다.
  ![image alt](image/Operators Guide/Maintenance4.PNG)
...
##### 3) 점검 상세내용 조회/수정/삭제
![image alt](image/Operators Guide/Maintenance3.PNG)
...
##### 3) 공지 상세내용 조회/수정/삭제
![image alt](image/Operators Guide/Notice3.PNG)
...
##### 1) 회원 기본정보 조회
![image alt](image/Operators Guide/Member_Member1.PNG)
...
##### 2) Login History
![image alt](image/Operators Guide/Member_LoginHistory1.PNG)
...
##### 5) Playtime
![image alt](image/Operators Guide/Member_Playtime1.PNG)
...
##### 1) 조회
![image alt](image/Operators Guide/IAP_App1.PNG)
- 게임에서 사용하기 위해 등록한 스토어들에 대한 정보를 조회할 수 있습니다.
- 
##### 2) 등록
![image alt](image/Operators Guide/IAP_App2.PNG)
...
##### 3) 조회/수정/삭제
![image alt](image/Operators Guide/IAP_App3.PNG)
...
##### 1) 조회
![image alt](image/Operators Guide/IAP_Item1.PNG)
- 현재 스토어에 등록된 아이템 리스트를 조회할 수 있습니다.
- 기본적으로는 모든 스토어에 대한 아이템을 노출하며, 각 스토어별 필터링 기능도 제공합니다.
- 
##### 2) 등록
![image alt](image/Operators Guide/IAP_Item2.PNG)
- 상품을 등록하기 위한 스토어를 등록할 수 있습니다.
- **(1) 스토어**
  등록하고자 하는 외부 스토어를 선택합니다.
...
##### 3) 조회/수정/삭제
![image alt](image/Operators Guide/IAP_Item3.PNG)
...
### 결제 정보
![image alt](image/Operators Guide/IAP_Transaction1.PNG)
...
### 권한
![image alt](image/Operators Guide/Management_Authorization1.PNG)
...
### 알람
![image alt](image/Operators Guide/Management_Alarm1.PNG)
...
### 알람 로그
![image alt](image/Operators Guide/Management_AlarmLog1.PNG)
