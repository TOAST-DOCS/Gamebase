...
If a situation occurs where payment completion must be awaited, such as slow payments or those requiring parental consent, the **GamebaseError.PURCHASE_PENDING** error is returned.
