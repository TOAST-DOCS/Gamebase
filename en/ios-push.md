...
* For tasks such as collecting inbound indicators and setting the notification sound, see [NHN Cloud Push Guide](/nhncloud-sdk/en/push-ios/#notification-service-extension) to implement the **Notification Service Extension** for the application.
