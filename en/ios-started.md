...
| --- | --- | --- | --- | --- |
| Gamebase | Gamebase.xcframework<br/>Gamebase.bundle | NHNCloudSDK 1.8.3 | Includes the interface and key logic of Gamebase | iOS 12 or later |
...
| Gamebase IAP Adapters | GamebasePurchaseIAPAdapter.xcframework | StoreKit<br/>NHNCloudIAP 1.8.3 | Supports in-game purchase | iOS 12 or later |
| Gamebase Push Adapters | GamebasePushAdapter.xcframework | NHNCloudPush 1.8.3 | Supports Push | iOS 12 or later |
