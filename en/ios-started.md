...
|  | GamebaseAuthHangameAdapter.framework | HangameID SDK 1.8.0 | Supports Hangame login | iOS 9 or later |
|  | GamebaseAuthWeiboAdapter.framework | weibo_ios_sdk-3.2.7 | Supports Weibo login | iOS 9 or later |
|  | GamebaseAuthKakaogameAdapter.framework | KakaoGame 3.14.4 | Supports Kakao login | iOS 11 or later |
| Gamebase IAP Adapters | GamebasePurchaseIAPAdapter.framework | StoreKit.framework<br/>NHNCloudIAP 1.2.0<br/> ToastGamebaseIAP 0.15.0 | Supports in-game purchase | iOS 9 or later |
