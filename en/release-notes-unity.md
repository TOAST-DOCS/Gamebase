...
* [SDK] Setting Tool
    * v2.0.0 has been newly released.
    * You must completely delete the existing SettingTool and then reinstall it.
    * Check the guide below for changes and how to use them.
