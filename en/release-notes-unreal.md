...
## Game > Gamebase > Release Notes > Unreal { #game-gamebase-release-notes-unreal }
...
* Added the `FGamebaseLaunchingInfo::FApp::FGameNotice::LatestNoticeTimeMillis` field to provide the post time of the most recently posted game announcement.
...
* (Windows) Support login via external browsers when Steamworks SDK is not loaded during Steam authentication.
...
#### Bug Fixes
* (Windows) Fixed an issue where Google Payments would not deliver results to the game after payment completion, depending on browser login status.
...
### 2.15.0 (October 27, 2020) { #150-october-27-2020 }
...
### 2.9.1 (August 25, 2020) { #91-august-25-2020 }
...
### 2.9.0 (May 12, 2020) { #90-may-12-2020 }
