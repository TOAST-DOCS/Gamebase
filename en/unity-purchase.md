...
4. The game server request for Consume API to the Gamebase server via API. [API Guide](/en/Game/Gamebase/ko/api-guide/#wrapping-api)
...
* For IAP error codes, refer to the document below.
    * [Mobile Service > IAP > Error Code > Client API Error Typ](/en/Common/IAP/ko/error-code/#client-api)
