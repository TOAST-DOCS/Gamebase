...
## Game > Gamebase > Android SDK ご利用ガイド > Push { #game-gamebase-android-developers-guide-push }
...
[Game > Gamebase > Android SDK使用ガイド > プッシュ > Notification Options > Set Notification Options with RegisterPush in Runtime](#notification-options-set-notification-options-with-registerpush-in-runtime)
