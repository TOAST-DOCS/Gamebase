...
|  | gamebase-adapter-auth-hangame | hangame-id-1.6.1 | Hangameログインをサポート | - |
...
* 決済テストを行うために、ストアごとに次のようにテスターとして登録します。(Gamebase Tester登録ではなく、ストアのテスト決済を行うための設定です。)
    ...
    * ONE store
        * [ONE store > Document > 開発ツール > (OLD Version)アプリ内決済ガイド > ONEstoreアプリ内決済API V5 (SDK V17)案内およびダウンロード > アプリ内決済テストおよびセキュリティ > テストID登録/管理](https://dev.onestore.co.kr/wiki/ko/doc/決済-テスト-および-セキュリティ-1572991.html#id-決済テストおよびセキュリティ-テストID登録/管理)
        * [ONE store > Document > 開発ツール > (OLD Version)アプリ内決済ガイド > ONEstoreアプリ内決済API V6 (SDK V19)案内およびダウンロード > アプリ内決済テストおよびセキュリティ > テストID登録/管理](https://dev.onestore.co.kr/wiki/ko/doc/アプリ内決済-テスト-および-セキュリティ-8290959.html#id-アプリ内決済テストおよびセキュリティ-テストID登録/管理)
        * `現在未サポート` [ONE store > Document > 開発ツール > ONEstoreアプリ内決済API V7 (SDK V21)案内およびダウンロード > 03. 決済テストおよびセキュリティ > テストID登録/管理](https://dev.onestore.co.kr/wiki/ko/doc/03-37552542.html#id-03.決済テストおよびセキュリティ-テストID登録/管理)
    * GALAXY Store
