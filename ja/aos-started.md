...
|  | gamebase-adapter-auth-hangame | hangame-id-1.4.5 | Hangameログインをサポート | - |
...
| Gamebase IAP Adapters | gamebase-adapter-toastiap | toast-gamebase-iap-0.18.3<br>toast-iap-core | ゲーム内決済をサポート | - |
