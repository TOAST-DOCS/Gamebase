...
## Game > Gamebase > ストアコンソールガイド > Epic Games Store コンソールガイド { #game-gamebase-store-console-guide-epic-games-store-console-guide }
...
![Epicサンドボックス環境](../static/images/StoreConsoleGuide/epic_games_store_console_guide_en_sandbox.png)
...
![Epicデプロイ作成](../static/images/console_epic/epic_console_sandbox_02_kor.png)
...
![Epicクライアントポリシー作成](../static/images/console_epic/epic_console_app_01_kor.png)

* クライアントポリシーの追加後にクライアントを作成します。

![Epicクライアント作成](../static/images/console_epic/epic_console_app_02_kor.png)
...
![Epicアプリ情報](../static/images/console_epic/epic_console_app_03_kor.png)

* **デプロイID**、**クライアントID**、**クライアント秘密鍵**、**サンドボックスID**をGamebase情報に登録します。

![Epicアプリ登録](../static/images/StoreConsoleGuide/epic_games_store_console_guide_ja_01_registration.png)
...
![Epicオファー登録](../static/images/console_epic/epic_console_item_01_kor.png)
![Epicオファー登録](../static/images/console_epic/epic_console_item_02_kor.png)

<a id="check-item-id-and-register-item"></a>
### アイテムIDの確認およびItem登録 { #check-item-id-and-register-item }
* アイテムIDの確認は登録後、オファーの詳細情報から確認できます。
* ID項目で**対象アイテムID**をGamebaseの**Store Item ID**に登録します。

![Epicアイテム登録](../static/images/console_epic/epic_console_item_03_kor.png)
![Epicアイテム登録](../static/images/StoreConsoleGuide/epic_games_store_console_guide_ja_02_item_registration.png)
