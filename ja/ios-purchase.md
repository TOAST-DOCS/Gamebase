...
| TCGB_ERROR_PURCHASE_PENDING                          | 4008       | 決済を完了するには追加の確認が必要です。 |
...
* NHN Cloud IAPエラーコードは、次の文書を参照してください。
    * [NHN Cloud > NHN Cloud SDK使用ガイド > NHN Cloud IAP > iOS > エラーコード](https://docs.nhncloud.com/ja/nhncloud-sdk/ja/iap-ios/#_17)
