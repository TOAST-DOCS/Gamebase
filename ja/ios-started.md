...
| --- | --- | --- | --- | --- |
| Gamebase | Gamebase.xcframework<br/>Gamebase.bundle | NHNCloudSDK 1.8.3 | GamebaseのInterfaceおよびコアロジックを含む | iOS 12以上 |
...
| Gamebase IAP Adapters | GamebasePurchaseIAPAdapter.xcframework | StoreKit.xcframework<br/>NHNCloudIAP 1.8.3 | ゲーム内決済をサポート | iOS 12以上 |
| Gamebase Push Adapters | GamebasePushAdapter.xcframework | NHNCloudPush 1.8.3 | Pushをサポート | iOS 12以上 |
