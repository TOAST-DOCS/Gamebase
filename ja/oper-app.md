...
## Transfer account
앱을 이용하는 유저가 별다른 아이디 제공자를 이용하지 않고 개별적으로 ID/비밀번호를 이용해 플레이할 수 있는 기기 이전 기능을 지원합니다.
이 기능은 일반적으로 활성화 되어 있지 않으며 기능 사용을 원하실 경우 별도로 활성화를 시켜주셔야 이용하실 수 있습니다.

![gamebase_app_20_201812.png](./image/Operators_Guide/Console_App_TransferAccount1_1.0.png)
1) 최초 기기 이전 기능을 활성화 하시려면 **사용하기** 버튼을 누르신 후 설정을 저장해 주셔야 합니다. 사용하기 버튼을 누르면 아래와 같은 화면으로 전환됩니다.

![gamebase_app_20_201812.png](./image/Operators_Guide/Console_App_TransferAccount1_2.0.png)
사용하기 버튼을 누르면 위와 같이 화면이 전환되며 기기 이전 관련 설정을 진행하실 수 있습니다.
...
#### 초기 설정 완료 이후
![gamebase_app_20_201812.png](./image/Operators_Guide/Console_App_TransferAccount1_3.0.png)
최초 설정이 완료되면 유저는 해당 기능을 비활성화만 할 수 있으며 설정변경이 필요할 경우 어드민에게 문의해야 합니다.
비활성화를 하게 되면 기존에 발급된 계정은 모두 사용할 수 없게되므로 한번 활성화 한 이후에는 비활성화 여부를 신중하게 선택해야 합니다.
