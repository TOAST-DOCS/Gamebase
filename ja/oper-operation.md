...
![gamebase_op_01_202004_ja](https://static.toastoven.net/prod_gamebase/gamebase_op_01_202004_ja.png)
...
![gamebase_op_04_202004_ja](https://static.toastoven.net/prod_gamebase/gamebase_op_04_202004_ja.png)
...
- 一部クライアント：特定のクライアントバージョンでのみメンテナンスが必要な場合に選択します。「バージョン選択」ボタンをクリックすると、クライアントメニューから登録したクライアントバージョンのリストが出力されます。
  **[一部クライアントを選択した時の画面の例]**
  ...
  ![gamebase_op_05_202004_ja](https://static.toastoven.net/prod_gamebase/gamebase_op_05_202004_ja.png)
...
![gamebase_op_05_202004_page1_ja](http://static.toastoven.net/prod_gamebase/gamebase_op_05_202004_page1_ja.png)
...
![gamebase_op_05_202004_page2_ja](http://static.toastoven.net/prod_gamebase/gamebase_op_05_202004_page2_ja.png)
...
##### 3) 外部ページ
![gamebase_op_05_202004_page3_ja](http://static.toastoven.net/prod_gamebase/gamebase_op_05_202004_page3_ja.png)
...
![gamebase_op_06_202004_ja](https://static.toastoven.net/prod_gamebase/gamebase_op_06_202004_ja.png)
...
![gamebase_op_07_202004_ja](https://static.toastoven.net/prod_gamebase/gamebase_op_07_202004_ja.png)
...
- 全ての国：すべてのユーザーに表示
- 一部の国：選択した国のユーザーに対してだけお知らせを表示。 
  追加する国コードを入力すると自動で完成され、入力されます。入力する国コードがない場合、[カスタマーセンター](https://toast.com/support/inquiry)までご連絡ください。

> [参考]
> 国判断基準
> ユーザーの**USIMの国コード**を基に判断し、USIMがない場合、**Device**に設定されている国を基にお知らせが表示されます。
...
#### (4) 表示時間
お知らせが表示される時間を設定します。
Timezoneの場合、基本的に「UTC+09:00」が選択されており、サービスする国の時間帯を選択してメンテナンスを登録することもできます。
