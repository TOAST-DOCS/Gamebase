...
![gamebase_push_01_202004_ja](https://static.toastoven.net/prod_gamebase/gamebase_push_01_202004_ja.png)
...
![gamebase_push_02_202004_ja](https://static.toastoven.net/prod_gamebase/gamebase_push_02_202004_ja.png)
...
![gamebase_push_04_202004_ja](https://static.toastoven.net/prod_gamebase/gamebase_push_04_202004_ja.png)
...
![gamebase_pushold_01_202004_ja](https://static.toastoven.net/prod_gamebase/gamebase_pushold_01_202004_ja.png)
...
![gamebase_pushold_02_202004_ja](https://static.toastoven.net/prod_gamebase/gamebase_pushold_02_202004_ja.png)

### Push登録

新しいPushを登録したい場合、**登録**ボタンをクリックします。

![gamebase_pushold_03_202004_ja](https://static.toastoven.net/prod_gamebase/gamebase_pushold_03_202004_ja.png)
...
- **情報提供型**：入力されたメッセージのみPushメッセージで送信されます。韓国の端末でない(USIMの国コードが韓国ではない)ユーザーには、情報提供型メッセージとして送信してください。
...
- **予約送信**：予約した時間にPushメッセージを送信します。ユーザー端末の国時間を基準にPushメッセージを送信したい場合、**現地時間を基準に送信**を選択します。**現地時間を基準に送信**を選択して、「2017-01-01 09:00」に設定した場合、韓国の端末を使用するユーザーは、韓国時間の「2017-01-01 09:00」に、英国の端末を使用するユーザーは、英国時間の「2017-01-01 09:00」にPushメッセージを受信します。

今後、予約送信の機能に繰り返し送信(毎日、毎週、毎月)する機能が追加で提供される予定です。

#### (4) 対象国

Pushメッセージを送信する国を選択します。

- **全ての国**：すべてのユーザーにPushメッセージを送信します。
- **一部の国**：選択した国のユーザーにのみPushメッセージを送信します。 
  追加したい国名を入力すると自動で完成され、入力されます。入力した国が表示されない場合、[カスタマーセンター](https://toast.com/support/inquiry)までご連絡ください。

> [参考]
> 国判断基準
> ユーザーの**USIMの国コード**を基に判断し、USIMがない場合は端末に設定されている国を基にPushメッセージが表示されます。
...
![gamebase_push_06_202004_ja](https://static.toastoven.net/prod_gamebase/gamebase_push_06_202004_ja.png)

TOAST Pushでプッシュ送信時に使用するタグ名を登録できます。

### タグ登録

![gamebase_push_09_202004_ja](https://static.toastoven.net/prod_gamebase/gamebase_push_09_202004_ja.png)
...
![gamebase_push_08_202004_ja](https://static.toastoven.net/prod_gamebase/gamebase_push_08_202004_ja.png)

##### ファイル

![gamebase_push_10_202004_ja](https://static.toastoven.net/prod_gamebase/gamebase_push_10_202004_ja.png)
...
![gamebase_push_11_202004_ja](https://static.toastoven.net/prod_gamebase/gamebase_push_11_202004_ja.png)
