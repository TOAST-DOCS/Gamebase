...
* Google の OOAP (Out-Of App Purchases) 購入が成功すると、Gamebase Event Handler の Purchase Updated イベントが発生します。
    * [Game > Gamebase > Android SDK 使用ガイド > ETC > Additional Features > Gamebase Event Handler > Purchase Updated](./aos-etc/#gamebase-event-handler-purchase-updated)
