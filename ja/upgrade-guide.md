...
* Gamebase SDK 2.65.0でイメージ告知機能を使用する際に発生する問題を修正しました。
    * 表示するイメージ告知がない場合、エラーの代わりに成功コールバックが呼び出されるように変更しました。
    * 登録されたイメージ告知がない場合、空白の告知画面が表示される問題を修正しました。
    * イシューが解決されたGamebase SDK 2.65.1以上を使用してください。
