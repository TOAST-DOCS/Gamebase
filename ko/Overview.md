...
## Game > Gamebase > 개요 { #game-gamebase-overview }
...
## Funtional Guide { #functional-guide }
...
* [NHN Cloud > 콘솔 사용 가이드 > 멤버 관리](/nhncloud/ko/console-guide/#member-management)
...
### 개인정보 처리 및 준법에 대한 안내 { #information-on-privacy-and-compliance }
