...
| setStoreCode(String storeCode)           | O                          | **[Purchase]**<br/>TOAST 통합 인앱 결제 서비스인 IAP(In-App Purchase)를 사용한다면 어떤 스토어를 사용할지 설정해야 합니다.<br/>파라미터는 [IAP 문서](/ko/Common/IAP/ko/Overview/)를 참고하세요. |
