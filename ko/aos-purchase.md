## Game > Gamebase > Android SDK 사용 가이드 > Purchase
...
* IAP 오류 코드는 다음 문서를 참고하시기 바랍니다.
  - [IAP > Error Code Guide > Client API 에러 타입](http://alpha-docs.cloud.toast.com/ko/Mobile%20Service/IAP/ko/error-code/#client-api)
