...
|  | gamebase-adapter-auth-kakaogame | kakaogame.idp_kakao-3.17.5<br>kakaogame.gamesdk<br>kakaogame.common<br>kakao.sdk.v2-auth-2.13.0<br>kakao.sdk.v2-partner-auth<br>kakao.sdk.v2-common<br>play-services-ads-identifier-17.0.0 | Kakao 로그인을 지원 | API 21(Lollipop, OS 5.0) |
...
* Unity 빌드인 경우
    * 'Firebase Console > 프로젝트 설정' 에서 google-services.json 파일을 다운로드하고, xml 변환을 위한 **[generate_xml_from_google_services_json.exe](https://github.com/firebase/firebase-cpp-sdk/blob/main/generate_xml_from_google_services_json.exe)** 파일도 다운로드 한 후 아래 명령어를 실행하여 json 파일을 xml 파일로 변환시킬 수 있습니다.
