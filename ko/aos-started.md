...
|  | gamebase-adapter-auth-hangame | hangame-id-1.6.2 | Hangame 로그인을 지원 | - |
...
|  | gamebase-adapter-auth-payco | payco-login-1.5.9 | PAYCO 로그인을 지원 | - |
...
|  | gamebase-adapter-auth-kakaogame | kakaogame.idp_kakao-3.14.14<br>kakaogame.gamesdk<br>kakaogame.common<br>kakao.sdk.v2-auth-2.11.0<br>kakao.sdk.v2-partner-auth<br>kakao.sdk.v2-common<br>play-services-ads-identifier-17.0.0 | Kakao 로그인을 지원 | API 21(Lollipop, OS 5.0) |
