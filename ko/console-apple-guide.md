...
### Gamebase 정보에 앱 내 구입 키 입력 { #enter-the-in-app-purchase-key-in-the-store-information }
...
### 스토어 정보 등록에 Shared Secret 입력 { #enter-the-shared-secret-in-the-store-information }
