...
## Game > Gamebase > 스토어 콘솔 가이드 > Google 콘솔 가이드 { #game-gamebase-store-console-guide-google-console-guide }
...
### 4. Gamebase IAP 앱에서 클라이언트 정보 설정 { #set-up-client-information-in-gamebase-iap-app }
...
### 4. NHN Cloud IAP 앱에서 서비스 계정 설정 { #set-up-a-service-account-in-the-gamebase-iap-app }
