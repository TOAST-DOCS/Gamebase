...
* 수신 지표 수집, 알림음 설정 등을 위해서는 [NHN Cloud Push 가이드](/nhncloud-sdk/ko/push-ios/#notification-service-extension)를 참고하여 애플리케이션에 **Notification Service Extension**을 구현해야 합니다.
