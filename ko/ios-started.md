...
| --- | --- | --- | --- | --- |
| Gamebase | Gamebase.framework<br/>Gamebase.bundle | ToastSDK 0.28.0 | Gamebase의 Interface 및 핵심 로직을 포함 | iOS9 or later
...
|  | GamebaseAuthHangameAdapter.framework | HangameID SDK 1.6.0 | Hangame 로그인을 지원 | iOS9 or later |
|  | GamebaseAuthWeiboAdapter.framework | weibo_ios_sdk-3.2.7 | Weibo 로그인을 지원 | iOS9 or later |
| Gamebase IAP | GamebasePurchaseIAPAdapter.framework | StoreKit.framework<br/>ToastIAP 0.28.0<br/> ToastGamebaseIAP 0.12.0 | 게임 내 결제를 지원 | iOS9 or later |
| Gamebase Push | GamebasePushAdapter.framework | ToastPush 0.28.0 | Push를 지원 | iOS9 or later |
