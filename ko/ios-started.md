...
| --- | --- | --- | --- | --- |
| Gamebase | Gamebase.framework<br/>Gamebase.bundle | ToastSDK 0.29.1 | Gamebase의 Interface 및 핵심 로직을 포함 | iOS9 or later
...
| Gamebase IAP | GamebasePurchaseIAPAdapter.framework | StoreKit.framework<br/>ToastIAP 0.29.1<br/> ToastGamebaseIAP 0.12.1 | 게임 내 결제를 지원 | iOS9 or later |
| Gamebase Push | GamebasePushAdapter.framework | ToastPush 0.29.1 | Push를 지원 | iOS9 or later |
