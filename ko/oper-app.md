...
Device Key와 등록 단말기의 **추가 정보** 및 Debug log, 점검 무시 여부를 입력 후 등록 버튼을 누르면 테스트 단말기로 등록됩니다.
...
#### (5) Debug log
Gamebae SDK의 Debug Log 저장 여부를 Console을 통하여 실시간으로 변경할 수 있습니다.
설정되어 있지 않으면 기본적으로 Gamebase SDK 내부에 설정된 값을 우선으로 동작하고 Console에서 Debug Log 저장할지 여부를 설정하실 수 있습니다.
Gamebase SDK에 Debug Log가 'OFF"상태이더라도 Console에서 'ON'으로 설정하시면 단말기에 Gamebase Debug Log를 저장하실 수 있습니다.
