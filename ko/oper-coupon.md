...
현재는 시리얼 쿠폰만 발급 가능하나, 이후 키워드 쿠폰도 제공할 예정입니다.
...
- **스토어**: 쿠폰을 사용할 수 있는 스토어로, 2020년 3월 현재는 전체만 지원하며 이후 스토어별 쿠폰 등록 기능 제공 예정
...
지금은 **전체** 쿠폰만 발급할 수 있으며 추후 별도 스토어별 쿠폰을 발급할 수 있도록 항목이 추가될 예정입니다.
