...
### 기능 개선/변경
* 앱 > 앱
    * NHN Cloud Online Contact 화면에 입력하는 Token 검증 URL 도메인이 `https://gamebase-web.cloud.toast.com`에서  `https://web-gamebase.nhncloud.com`으로 변경 되었습니다.
...
* Analytics > 이용자 지표 > 이용자 지표
	* 일간 엑셀 다운로드 시 누락 되었던 누적 DAU 지표 추가
