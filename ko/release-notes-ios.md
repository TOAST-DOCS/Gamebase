...
### 2.21.0(2021.04.13) [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.21.0/GamebaseSDK-iOS.zip)
...
### 2.20.2(2021.03.23) [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.20.2/GamebaseSDK-iOS.zip)

#### 기능 개선/변경
* Facebook iOS SDK 업데이트 (9.1.0)
* 특정 경우에 GamebaseAuthFacebookAdapter에서 openURL delegate가 호출되지 않았던 이슈 수정

### 2.20.1(2021.03.09) [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.20.1/GamebaseSDK-iOS.zip)

#### 기능 개선/변경
* iOS 14에 대응하여 IDFA 획득 로직 수정: info.plist에 NSUserTrackingUsageDescription 필드 추가

### 2.20.0(2021.02.09) [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.20.0/GamebaseSDK-iOS.zip)
...
### 2.19.1(2021.01.26) [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.19.1/GamebaseSDK-iOS.zip)
...
### 2020. 12. 29. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.19.0/GamebaseSDK-iOS.zip)
...
### 2020. 12. 15. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.18.2/GamebaseSDK-iOS.zip)
...
### 2020. 11. 10. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.18.0/GamebaseSDK-iOS.zip)
...
### 2020. 10. 27. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.17.1/GamebaseSDK-iOS.zip)
...
### 2020. 10. 13. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.17.0/GamebaseSDK-iOS.zip)
...
### 2020. 09. 22. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.16.0/GamebaseSDK-iOS.zip)
...
### 2020. 09. 16. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.15.1/GamebaseSDK-iOS.zip)
...
### 2020. 08. 25. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.15.0/GamebaseSDK-iOS.zip)
...
### 2020. 08. 11. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.14.0/GamebaseSDK-iOS.zip)
...
### 2020. 07. 28. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.13.0/GamebaseSDK-iOS.zip)
...
### 2020. 07. 14. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.12.0/GamebaseSDK-iOS.zip)
...
### 2020. 06. 23. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.11.0/GamebaseSDK-iOS.zip)
...
### 2020. 06. 09. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.10.1/GamebaseSDK-iOS.zip)
...
### 2020. 05. 26. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.10.0/GamebaseSDK-iOS.zip)
...
### 2020. 05. 12. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.9.1/GamebaseSDK-iOS.zip)
...
### 2020. 04. 28. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.9.0/GamebaseSDK-iOS.zip)
...
### 2020. 04. 14. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.8.1/GamebaseSDK-iOS.zip)
...
### 2020. 03. 24. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.8.0/GamebaseSDK-iOS.zip)
...
### 2020. 02. 25. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.7.1/GamebaseSDK-iOS.zip)
...
### 2019. 12. 24. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.6.2/GamebaseSDK-iOS.zip)
...
### 2019. 12. 10. [SDK 다운로드](https://static.toastoven.net/toastcloud/sdk_download/gamebase/v2.6.1/GamebaseSDK-iOS.zip)
...
#### 기능 추가
* [SDK] 2.5.0
	* (공통) Console에서 입력한 CS URL을 웹뷰로 오픈하는 API 제공
