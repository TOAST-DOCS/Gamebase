...
## Game > Gamebase > Unreal SDK 사용 가이드 > 인증 { #game-gamebase-user-guide-for-unreal-sdk-authentication }
...
| GamebaseAuthProviderCredential::LineChannelRegion | LINE 서비스 제공 지역 설정 | [Login with IdP 참고](#login-with-idp) |
