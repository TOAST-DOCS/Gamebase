...
- 所有国家：向所有用户发布公告。
- 部分国家：仅向所选国家的用户发布公告。
输入要添加的国家代码，它将自动完成。如果想选择的国家代码不存在，请通过[客服中心](https://toast.com/support/inquiry)与我们联系。
...
在语言列表中如果没有用户匹配语言，将显示选择为“默认语言”的语言。点击右侧的** + **按钮可以添加语言。如果需要添加新语言，请通过[客服中心](https://toast.com/support/inquiry)与我们联系。
如果点击”翻译”按键，则将默认语言翻译成各项目的设置语言。
...
#### (4) 显示时间
设置显示图片通知的时间。
时区的默认选项为“UTC + 09：00”，也可以通过选择提供服务的国家的时区来设置维护。
...
不向游戏用户公开输入的信息。请输入注册此踢出的简单的理由。

### (3) 消息
是将要向用户显示的踢出消息。 
如果选择”默认语言自动翻译”按钮，则根据使用默认语言输入的内容，翻译内容后，将按每个项目设置的语言自动输入内容。
